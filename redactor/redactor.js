    ...
    Redactor.prototype = {
        ...
        build: function (mobile, whendone) {
            if (mobile !== true) {
                ...
                if (this.$editor) {
                    let contenteditable = ('readonly' !== this.$el.attr('readonly'));
                    this.$editor.addClass('redactor_editor').attr('contenteditable', contenteditable).attr('dir', this.opts.direction);
                }
